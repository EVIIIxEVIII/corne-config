...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x6_3_ex2(
        ...
        KC_NO, LGUI_T(KC_A), LALT_T(KC_S), LCTL_T(KC_D),  LSFT_T(KC_F),  KC_G,         KC_NO,             KC_NO,        KC_H, LSFT_T(KC_J),  LCTL_T(KC_K),   LALT_T(KC_L),   LGUI_T(KC_SCLN), KC_QUOTE,
    ...
    [1] = LAYOUT_split_3x6_3_ex2(
        ...
        KC_NO, KC_LGUI,      KC_LALT,      KC_LCTL,      KC_LSFT,      KC_NO,        KC_NO,             KC_NO,        KC_LEFT, KC_DOWN,       KC_UP,         KC_RGHT,       KC_CAPS,      KC_NO,
    ...
    [2] = LAYOUT_split_3x6_3_ex2(
        ...
        KC_NO, KC_LGUI,      KC_LALT,      KC_LCTL,      KC_LSFT,      KC_NO,        KC_NO,             KC_NO,        KC_NO,   KC_MS_L,      KC_MS_D,      KC_MS_U,      KC_MS_R,      KC_NO,
    ...
    [6] = LAYOUT_split_3x6_3_ex2(
        ...
        KC_NO, KC_F11,       KC_F4,        KC_F5,        KC_F6,        KC_SLCT,      KC_NO,             KC_NO,        KC_NO,   KC_LSFT,      KC_LCTL,      KC_LALT,      KC_LGUI,      KC_NO,
